    ...
    <div class="flex flex-col md:flex-row items-center bg-white overflow-hidden max-w-6xl ">
        ...
        <div class="w-full md:w-1/2 p-12">
            ...
            <div class="xl:flex items-center md:space-x-6 mt-5 ">
                ...
                <button id="cart" class="w-full bg-orange-500 shadow-xl text-white text-md font-bold px-16 py-4 my-2 rounded-lg hover:bg-orange-700 flex items-center space-x-5 justify-center">
